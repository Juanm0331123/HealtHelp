 ...
 * @author user 123
 */
public class HH_MensajeError extends javax.swing.JDialog {

    /**
     * Creates new form HH_FechaCita
     */
    public HH_MensajeError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        LbNombre.setFont(new java.awt.Font("Segoe Script", 3, 16)); // NOI18N
        LbNombre.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LbNombre.setText("Sr. Rosendo Bucurú");
        PanelFechaCita.add(LbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 380, -1));
        ...
        Lb1.setText("Ha ocurrido un error al agendar la cita.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HH_MensajeError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HH_MensajeError dialog = new HH_MensajeError(new javax.swing.JFrame(), true);
