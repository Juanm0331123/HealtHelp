 ...
 * @author user 123
 */
public class HH_MensajeErrorGeneral extends javax.swing.JDialog {

    /**
     * Creates new form HH_FechaCita
     */
    public HH_MensajeErrorGeneral(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        LbTituloFechaCita.setFont(new java.awt.Font("Segoe UI Semibold", 1, 40)); // NOI18N
        ...
        LbProfesionalSaludAgendarCita.setText("base de datos. Intentalo nuevamente.");
        PanelFechaCita.add(LbProfesionalSaludAgendarCita, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 340, 20));
        ...
        LbProfesionalSaludAgendarCita1.setText("Los datos colocados no se encuentran en la");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HH_MensajeErrorGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HH_MensajeErrorGeneral dialog = new HH_MensajeErrorGeneral(new javax.swing.JFrame(), true);
